...
export default class MultiSelect extends Component {
  ...
  static defaultProps = {
    ...
    selectedTextColor: colorPack.textPrimary,
    errorColor: colorPack.danger,
    selectText: 'Select',
    altFontFamily: '',
  ...
  _getSelectLabel = () => {
    ...
    return `${selectedItems.length} wards selected`;
  };
        ...
        {selector ? (
          ...
          <View>
                ...
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  <View
                    style={
                      ...
                      : {flex: 1, flexDirection: 'row', alignItems: 'center', paddingLeft: 10}
                    }
                  >
                    <Text
                      style={
                          ...
                          ? [
                              {
                                ...
                                color: errorColor || colorPack.danger
                              },
                            ...
                            (!selectedItems || selectedItems.length === 0
                              ...
                              : [
                                  styleTextDropdownSelected && styleTextDropdownSelected,
                                  {
                                    flex: 1,
                                    fontSize: fontSize || 20,
                                    color: selectedTextColor || colorPack.placeholderTextColor
                                  }
                                ])
                      }
                      numberOfLines={1}
            ...
            </View>
            {
              error == "" ? null :
              <View>
                <Text style={{color: errorColor, fontSize: 12}}>{error}</Text>
              </View>
            }
